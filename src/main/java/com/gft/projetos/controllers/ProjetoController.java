...
public class ProjetoController {
	...
	public ModelAndView listarProjetos() {
		...
		mv.addObject("lista", projetoService.listarProjeto());
		
		return mv;
	}
	
	@RequestMapping(path = "visualizarProjeto")
	public ModelAndView visualizarProjeto(@RequestParam Long id) throws Exception {
		
		ModelAndView mv = new ModelAndView("projeto/visualizarProjeto.html");
		
		mv.addObject("projeto", projetoService.obterProjeto(id));
