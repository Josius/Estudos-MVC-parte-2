...
//	Método para criar um novo desenvolvedor e para editar um já alocado ao BD
	...
	public ModelAndView listarDesenvolvedores(String nome, String quatroLetras) {
		...
		mv.addObject("lista", desenvolvedorService.listarDesenvolvedor(nome, quatroLetras));
